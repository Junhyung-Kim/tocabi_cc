...
<< xd_mj_(1) << " "      << xd_mj_(2) << " "   << std::endl;
                ...
                if(mpc_cycle < controlwalk_time-1  && time_slow < 3 )
                {
                    ...
                    file[1] <<walking_tick_mj<< " " << mpc_cycle<< " " << ZMP_float(0) << " " << zmp_mpcx<< " " << ZMP_float(1) << " " << zmp_mpcy << " 5 "
                    
                    
                    /*" " << walking_tick<< " " << lfoot_support_current_.translation()(0)<< " " << lfoot_trajectory_support_.translation()(0)<< " " << lfoot_support_current_.translation()(1)<< " " << lfoot_trajectory_support_.translation()(1)<< " " << lfoot_support_current_.translation()(2)<< " " << lfoot_trajectory_support_.translation()(2)<< " " <<
                        rfoot_support_current_.translation()(0)<< " " << rfoot_trajectory_support_.translation()(0)<< " " <<rfoot_support_current_.translation()(1)<< " " << rfoot_trajectory_support_.translation()(1)<< " " <<rfoot_support_current_.translation()(2)<< " " << rfoot_trajectory_support_.translation()(2) << " " << state_init_[49] << " " << desired_val_slow[49] << " " << state_init_[49] - desired_val_slow[49] << " " << rd_.link_[COM_id].xpos(2)  << " " << com_desired_(2) << " " << com_support_current_(2)  << " " << com_support_current_[2] - com_desired_[2] << " " << model_data_cen.vcom[0][2] << " " << (rd_.link_[COM_id].xpos(2)-com_id_prev(2)) * 2000 
                        << " 5 "<< ZMP_float(0) << " " << zmp_mpcx<< " " << ZMP_float(1) << " " << zmp_mpcy << std::endl;*/
