...
CustomController::CustomController(RobotData &rd) : rd_(rd) //, wbc_(dc.wbc_)
{
    ...
    comj.setZero(6, MODEL_DOF_VIRTUAL);
...
void CustomController::computeSlow()
{
    ...
    tf2::Matrix3x3 m(q);
    tf2::Matrix3x3 m1(InitRPYM4.linear()(0,0),InitRPYM4.linear()(0,1),InitRPYM4.linear()(0,2),InitRPYM4.linear()(1,0),InitRPYM4.linear()(1,1),InitRPYM4.linear()(1,2),InitRPYM4.linear()(2,0),InitRPYM4.linear()(2,1),InitRPYM4.linear()(2,2));
    ...
    if(control_start == false && rd_.tc_.mode != 7)
    {  
        for (int i = 0; i < 3; i++)
    ...
    //q_pinocchio = q_pinocchio_desired1;
    ...
    if(rd_.tc_.mode == 7)
    {
        //zmp_x_int = (RF_matrix(mpc_cycle,0) - RFc_float_current.translation()(0)-0.03);//com_x_int;
    ...
    if(rd_.tc_.mode == 8 && walk_start1 == true)
    {
        if(lfootz <= 0.159 && rfootz <= 0.159)
        {
            ZMP(0) = ((ZMP_l(0) + model_data2.oMf[LFcframe_id].translation()(0))*rd_.LF_FT(2) + (ZMP_r(0) + model_data2.oMf[RFcframe_id].translation()(0))*rd_.RF_FT(2))/(rd_.RF_FT(2) + rd_.LF_FT(2));
            ZMP(1) = ((ZMP_l(1) + model_data2.oMf[LFcframe_id].translation()(1))*rd_.LF_FT(2) + (ZMP_r(1) + model_data2.oMf[RFcframe_id].translation()(1))*rd_.RF_FT(2))/(rd_.RF_FT(2) + rd_.LF_FT(2));
        }
        else if(lfootz <= 0.159)
        {
        ...
        {  
            ...
            {    
                ...
                H1(2,2) = 0.05;//0.1;
                H1(8,8) = 0.05;//0.1;
                g1(2) = - com_alpha * nle(2) * 0.05;
                g1(8) = - (1-com_alpha) * nle(2) * 0.05;
                lb1(2) = 0.0;
                lb1(8) = 0.0;
    ...
    {
        //file[0] << mpc_cycle << " " << walking_tick << " " <<solved << " "<<qp_solved << " "<< comt_[0] << " "<<COM_float_current.translation()(0)<< " "<< comt_[1] << " " << COM_float_current.translation()(1)<<" " <<comd_(1) <<" "<<com_z_init <<" " <<COM_float_current.translation()(2) <<" "<< comdt_[0] << " "<<COMv_float_current.translation()(0)<< " "<< comdt_[1] << " " << COMv_float_current.translation()(1)<<" " << rd_.link_[Pelvis].xpos(1) << " " << rd_.link_[COM_id].xpos(1) << " " <<model_data2.oMf[RFcframe_id].translation()(0) << " " << model_data2.oMf[RFcframe_id].translation()(1)  << " " <<RFc_float_current.translation()(1) << " " <<LFc_float_current.translation()(1) <<" " << zmpx << " " << ZMP_FT_law(0) << " " << zmpy << " " << ZMP_FT_law(1) << " " << comdt_(1) << " " << 0 << " " <<pelv_ori_c(0) << " " <<pelv_ori_c(1) << " " << rfoot_ori_c(0) << " " << rfoot_ori_c(1) << " " <<rfootd1(2) << " "<< rd_.RF_FT(2) << " " << rd_.LF_FT(2) << " " << qp_result(2)<<  " " << qp_result(8) << " "<< rd_.RF_FT(3) << " " << rd_.LF_FT(3)<<" "<< qp_result(3)<<  " " << qp_result(9) << " " << rd_.torque_desired(10) << " " << tau_[16] <<" " ;
       
           
        //file[0] << mpc_cycle << " " << walking_tick << " " << COM_float_current.translation()(0) << " "<< zmp_x_int << " " << rd_.link_[Right_Foot].xpos(0) << RF_matrix(mpc_cycle,0)  
        file[0] << mpc_cycle << " " << walking_tick << " " <<comt_[0] << " "<<COM_float_current.translation()(0)<< " " <<model_data2.com[0][0] << " "<<rd_.link_[COM_id].xpos(0)<< " " << comt_[1] << " " << COM_float_current.translation()(1)<< " " <<model_data2.com[0][1] << " " <<comdt_(0)<< " "  << comdt_(1)<< " " <<COMv_float_current.translation()(0) << " "<<COMv_float_current.translation()(1) << " "<<model_data2.oMf[RFcframe_id].translation()(1) << " " << model_data2.oMf[LFcframe_id].translation()(1) << " " << A1.block(22,6,1,6)(0,2)<< " " << A1.block(22,0,1,6)(0,2) << " " << zmpy << " " << ZMP_FT_law(1) << " "<< zmpx << " " << ZMP_FT_law(0) << " "<<zmp_x_int<< " " << zmp_y_int << " "<< rfoot_ori_c(0) << " " <<rfoot_ori_c(1) << " " << pelv_ori_c(0) << " "  << pelv_ori_c(1) << " ";//<< DyrosMath::rot2Euler(model_data2.oMf[RFcframe_id].rotation())(1) << " " <<DyrosMath::rot2Euler(model_data2.oMf[RFcframe_id].rotation())(0) << " " << lfoot_ori_c(1) << " " <<lfoot_ori_c(0) << " "<< DyrosMath::rot2Euler(model_data2.oMf[LFcframe_id].rotation())(1) << " " <<DyrosMath::rot2Euler(model_data2.oMf[LFcframe_id].rotation())(0) << " " << "333" << " ";
        for (int i = 0; i < 19; i++) //tau_[i+6] << " " << rd_.torque_desired[i] << " "
                file[0]  << q_pinocchio_desired1[i] << " " << q_pinocchio[i] << " ";
        for (int i = 0; i < 19; i++)
            file[0] <<  qp_result(12+i) << " " << qdd_pinocchio_desired1_(i) << " ";
...
void CustomController::computeFast()
{
    ...
    {    
        ...
        cc_mutex2.lock();
        PELV_float_current.linear() = InitRPYM5.linear() * rd_.link_[Pelvis].rotm;
        //std::cout << "InitRPYM5" << std::endl;
        //std::cout << InitRPYM5.linear() << std::endl;
        //std::cout << PELV_float_current.linear() << std::endl;
        ...
        Eigen::Vector3d pelv_rpy_current =  DyrosMath::rot2Euler(rd_.link_[Pelvis].rotm);
        Eigen::Isometry3d pelv_yaw_rot_current_from_global_;
        pelv_yaw_rot_current_from_global_.linear() = DyrosMath::rotateWithZ(pelv_rpy_current(2));
        Eigen::Vector3d sup_rpy_current =  DyrosMath::rot2Euler(rd_.link_[Right_Foot].rotm);
        Eigen::Isometry3d sup_yaw_rot_current_from_global_;
        sup_yaw_rot_current_from_global_.linear() = DyrosMath::rotateWithZ(sup_rpy_current(2));
        sup_yaw_rot_current_from_global_.translation() = model_data2.oMf[RFcframe_id].translation();

        
        RF_float_current.linear() = DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_) * rd_.link_[Right_Foot].rotm;
        RF_float_current.translation() = DyrosMath::multiplyIsometry3dVector3d(DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_), rd_.link_[Right_Foot].xpos); 
        
        Eigen::Isometry3d sup_float_current = RF_float_current;        
        
        InitRPYM = DyrosMath::inverseIsometry3d(sup_float_current);//DyrosMath::inverseIsometry3d(sup_yaw_rot_current_from_global_) * DyrosMath::inverseIsometry3d(pelv_yaw_rot_current_from_global_);

        InitRPYM4 = DyrosMath::inverseIsometry3d(sup_float_current);
        
        InitRPYM2.block(0,0,3,3) = InitRPYM.linear();
        InitRPYM2.block(3,3,3,3) = InitRPYM.linear();

        //initrpy(0) = -rd_.link_[Right_Foot].xpos(0) -0.03;//-model_data2.oMf[RFcframe_id].translation()(0);// - 0.03;//-model_data2.oMf[RFcframe_id].translation()(0);//-1 * (model_data2.oMf[RFcframe_id].translation()(0)+model_data2.oMf[LFcframe_id].translation()(0))/2;//-1 * rd_.link_[Pelvis].xpos(0);
        //initrpy(1) = -rd_.link_[Right_Foot].xpos(1);//-model_data2.oMf[RFcframe_id].translation()(1);//-model_data2.oMf[RFcframe_id].translation()(1);//-1 * (model_data2.oMf[RFcframe_id].translation()(1)+model_data2.oMf[LFcframe_id].translation()(1))/2;//-1 * rd_.link_[Pelvis].xpos(1);
        //initrpy(2) = -rd_.link_[Right_Foot].xpos(2);//-model_data2.oMf[RFcframe_id].translation()(2);//-model_data2.oMf[RFcframe_id].translation()(2);//-1 * model_data2.oMf[RFcframe_id].translation()(2);//-1 * rd_.link_[Pelvis].xpos(2);


        if(rd_.tc_.mode == 7 && print_cout == false)
        {
            
            if(pelv_frame == true)
                InitRPYM5.linear()= rd_.link_[Pelvis].rotm;
            else
                InitRPYM5.linear() = rd_.link_[Pelvis].rotm;//

            InitRPYM5.translation()(0) = model_data2.oMf[RFcframe_id].translation()(0);//(model_data2.oMf[RFcframe_id].translation()(0)+model_data2.oMf[LFcframe_id].translation()(0))/2;//rd_.link_[Pelvis].xpos(0);
            InitRPYM5.translation()(1) = model_data2.oMf[RFcframe_id].translation()(1);//(model_data2.oMf[RFcframe_id].translation()(1)+model_data2.oMf[LFcframe_id].translation()(1))/2;//rd_.link_[Pelvis].xpos(1);
            InitRPYM5.translation()(2) = model_data2.oMf[RFcframe_id].translation()(2);//model_data2.oMf[RFcframe_id].translation()(2);//rd_.link_[Pelvis].xpos(2);
            InitRPYM5 = DyrosMath::inverseIsometry3d(InitRPYM5);
            ...
            initrpy(0) = -model_data2.oMf[RFcframe_id].translation()(0);// - 0.03;//-model_data2.oMf[RFcframe_id].translation()(0);//-1 * (model_data2.oMf[RFcframe_id].translation()(0)+model_data2.oMf[LFcframe_id].translation()(0))/2;//-1 * rd_.link_[Pelvis].xpos(0);
            initrpy(1) = -model_data2.oMf[RFcframe_id].translation()(1);//-model_data2.oMf[RFcframe_id].translation()(1);//-1 * (model_data2.oMf[RFcframe_id].translation()(1)+model_data2.oMf[LFcframe_id].translation()(1))/2;//-1 * rd_.link_[Pelvis].xpos(1);
            initrpy(2) = -model_data2.oMf[RFcframe_id].translation()(2);//-model_data2.oMf[RFcframe_id].translation()(2);//-1 * model_data2.oMf[RFcframe_id].translation()(2);//-1 * rd_.link_[Pelvis].xpos(2);
            ...
            if(print_cout == false)
            {
                ...
                std::cout << rd_.link_[Right_Foot].xpos.transpose() << std::endl;
                std::cout << rd_.link_[Left_Foot].xpos.transpose() << std::endl;
                std::cout << InitRPYM.translation()(2) << std::endl;
                ...
                std::cout << model_data2.oMf[RFcframe_id].translation().transpose() << std::endl;
                std::cout << model_data2.oMf[LFcframe_id].translation().transpose() << std::endl;
            ...
            if(mpc_cycle < controlwalk_time && wlk_on == true && stateestimation == true)
            {
                ...
                {  
                    ...
                    if(rfoot_mpc(2)>0.159)
                    {
                        ...
                        rfootd1(1) = rfootd1(1) + 10.00 * (-0.1025 - RF_float_current.translation()(1) - virtual_temp1(0));
                    ...
                    qdd_pinocchio_desired1_raw = ((qd_pinocchio - qd_pinocchio_prev)/0.0005);
                   
                    //if(walking_tick == 0 || walking_tick == 39 || walking_tick == 40)
                   // {
    ...
    if(control_start == true && rd_.tc_.mode == 8)
    {
        //WBC::SetContact(rd_, 1, 1);
    ...
    else if(rd_.tc_.mode == 6 || rd_.tc_.mode == 7)
    {
        if(rd_.tc_.mode == 6)
        {
            WBC::SetContact(rd_, 1, 1);
    ...
    if(walk_start == true && mpc_cycle < controlwalk_time && mpc_cycle >= 1)
    {
        ...
        //file[0] << mpc_cycle << " " << walking_tick << " " <<comt_[0] << " "<<COM_float_current.translation()(0)<< " " <<model_data2.com[0][0] << " "<<rd_.link_[COM_id].xpos(0)<< " " << comt_[1] << " " << COM_float_current.translation()(1)<< " " <<model_data2.com[0][1] << " "<<rd_.link_[COM_id].xpos(1)<< " "  << rd_.link_[Pelvis].xpos(0)<< " " << rd_.link_[Pelvis].xpos(1) << " "<<model_data2.oMf[RFcframe_id].translation()(1) << " " << model_data2.oMf[LFcframe_id].translation()(1) << " " << rd_.link_[Right_Foot].xpos(1)<< " " << rd_.link_[Left_Foot].xpos(1) << " " << zmpy << " " << ZMP_FT_law(1) << " "<< zmpx << " " << ZMP_FT_law(0) << " " << rfoot_ori_c(1) << " " <<rfoot_ori_c(0) << " "<< DyrosMath::rot2Euler(model_data2.oMf[RFcframe_id].rotation())(1) << " " <<DyrosMath::rot2Euler(model_data2.oMf[RFcframe_id].rotation())(0) << " " << lfoot_ori_c(1) << " " <<lfoot_ori_c(0) << " "<< DyrosMath::rot2Euler(model_data2.oMf[LFcframe_id].rotation())(1) << " " <<DyrosMath::rot2Euler(model_data2.oMf[LFcframe_id].rotation())(0) << " " << "333" << " ";
        //file[0] << 0 <<" ";
        //for(int i = 0; i < 12 ;i++ )
        //    file[0] << rd_.q_(i) << " ";
        //for (int i = 0; i < 12; i++) //tau_[i+6] << " " << rd_.torque_desired[i] << " "
...
void CustomController::momentumControl(RobotData &Robot, Eigen::Vector3d comd,  Eigen::Vector2d ang_, Eigen::Vector3d rfootd, Eigen::Vector3d lfootd, Eigen::Vector2d upperd, Eigen::Vector3d rfootori, Eigen::Vector3d lfootori)
{
    ...
    {  
        ...
        J2.block(0,0,3,18) = InitRPYM4.linear() * Robot.link_[COM_id].Jac().block(0,0,3,18);
