        ...
        {        
            ...
            {            
                if (wlk_on == false)
                {
                    ...
                    if(walking_tick <= 3000)
                    {
                        if(walking_tick <= 2500)
                        {
                            for (int i = 0; i < 33; i++)
                            {
                                rd_.q_desired(i) = DyrosMath::cubic(walking_tick, 0, 2500, q_init(i), q_desired(i), 0, 0);
                            }
                        }
                        else
                        {
