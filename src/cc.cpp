...
CustomController::CustomController(RobotData &rd) : rd_(rd)
{
    ...
    pinocchio::urdf::buildModel("/usr/local/lib/python3.8/dist-packages/robot_properties_tocabi/resources/urdf/tocabi.urdf", root_joint, model1);/*_0714*/
                        ...
                        if(walking_tick_stop == false || mpc_cycle <= 0)
                        {
                            ...
                            if(floating_Control == true)
                            {
                                ...
                                else
                                {
                                    ...
                                    com_d2(2) = com_d(2) + 0.0 * (com_desired_init(2) - com_support_current_(2));
                                }
                            }
                            else
                            {
                ...
                if(mpc_cycle < controlwalk_time-1  && time_slow < 3)
                {
                    ...
                    */
                    ...
                    if(time_slow == 0)
                    {
                        ...
                        , state_init_[46], desired_val_slow[46], state_init_[47], desired_val_slow[47], state_init_[48], desired_val_slow[48], 131, virtual_temp1(2), virtual_temp(2), rd_.link_[COM_id].xpos(2) + virtual_temp(2), com_desired_[2], com_support_current_(2);
                    }
                    else if(time_slow == 1)
                    {
