...
public:
    ...
    bool hipcompen = true; 
    bool momentumControlMode = false;
    bool pelvroll = false; 
    double left_hip_roll_temp , right_hip_roll_temp , left_hip_pitch_temp , right_hip_pitch_temp , left_ank_pitch_temp , right_ank_pitch_temp;
    ...
    Eigen::Vector3d com_d, rfoot_d, lfoot_d, rfoot_ori, lfoot_ori;
